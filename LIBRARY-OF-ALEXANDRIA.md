...
| 1 | **Financial & Economic Intelligence** | FRED (500K+ series), SEC EDGAR, BLS, Yahoo Finance, Alpha Vantage, Treasury Direct, FINRA TRACE | Macro indicators, market data, sector performance, commodity prices, interest rate curves, earnings history, dividend tracking, tax law changes | Continuous (market hours), daily (indicators), weekly (analysis) |
| 2 | **Geopolitical & World Events** | GDELT Project, Congress.gov API, UN data portals, Reuters/AP RSS, CIA World Factbook, think tank feeds | Conflict tracking, sanctions monitoring, trade agreements, policy changes, supply chain disruptions, election impacts, central bank actions | Every 6h (RSS/GDELT), daily (policy), weekly (deep analysis) |
| 3 | **AI/ML Research Sentinel** | arXiv API, Semantic Scholar, GitHub trending + search, HuggingFace Hub, Papers With Code | New papers mapped to Jarvis components, model releases with hardware compatibility, technique catalog, dependency monitoring, improvement proposals | Daily (arXiv/GitHub), weekly (deep evaluation) |
| 4 | **Legal & Regulatory** | Federal Register API, IRS publications, MN Legislature, city council feeds, CMS, consumer protection databases | Tax law changes, zoning updates, employment law, insurance regulation, consumer protection, compliance deadlines | Weekly (federal), bi-weekly (state/local) |
| 5 | **Health & Wellness** | PubMed/NIH, FDA OpenFDA, CDC, AirNow AQI, pollen APIs, CMS Compare, AAP guidelines | Nutrition science, drug interactions, seasonal health patterns, air quality, local provider quality, preventive care by age, exercise science | Weekly (research), daily (environmental) |
| 6 | **Local Intelligence** | Zillow API, county assessor, state DOE, local PD feeds, city permits, utility company APIs, community calendars | Real estate trends (zip-level), school performance, crime stats, infrastructure projects, utility rate changes, business openings/closings, neighborhood trends | Weekly (data pulls), monthly (trend analysis) |
| 7 | **Family & Life Quality** | AllTrails, TripAdvisor, Eventbrite, local parks/rec, school calendars, child development journals (AAP, PubMed), vacation planning sites | Local free/cheap family activities (hiking, events, exploring), vacation research and planning, age-appropriate bonding activities, parenting research, developmental milestones, screen time/sleep research, seasonal activity planning | Daily (local events), weekly (research), monthly (vacation planning) |

**Engine 7 deserves special attention.** This isn't just a data aggregator — it's a proactive family quality-of-life engine. Its job is to ensure that with all the technology running, the family is actually *spending time together well*. It should surface things like "There's a free outdoor movie at Lake Harriet this Friday and the weather looks perfect" or "You haven't done a family hike in 3 weeks — here are 3 easy trails within 30 minutes that the kids haven't tried" or "Next weekend is wide open — here's a road trip option that fits the budget." It reads from the calendar specialist to find open windows, from the finance specialist to know the budget, and from the weather data to time outdoor suggestions well.
