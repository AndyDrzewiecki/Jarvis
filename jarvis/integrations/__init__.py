"""
Jarvis external service integrations.

This package also exposes the integration path management functions
previously in jarvis/integrations.py for backward compatibility.
"""
